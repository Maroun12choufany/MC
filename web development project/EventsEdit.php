...
<form id="formData" action="updateEvent.php" method="POST" >
    <label for="Creator">Creator:</label>
    <label type="text"  ><?php  echo $_SESSION["email"]; ?></label><br><br>
   
    <label for="name">EventName:</label>
    <input type="text" id="name" name="name" required="" value=<?php echo $EventName; ?>><br><br>
    <label for="date">Date:</label>
    <input type="date" id="date" name="date" required="" value=<?php echo $EventDate; ?>><br><br>
    <label for="time">Time:</label>
    <input type="time" id="time" name="time" required="" value=<?php echo $EventTime; ?>><br><br>
    <label for="location">Location:</label>
    <input type="text" id="location" name="location" value=<?php echo $EventLocation; ?> ><br><br>
    <input  hidden type="text" id="eventid" name="eventid" value=<?php echo $_POST["eventid"]; ?> ><br><br>
